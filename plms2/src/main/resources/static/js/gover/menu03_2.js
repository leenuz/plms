...
$(document).on("click","#excelDownloadBtn",function(){
		...
		var formSerializeArray = $('#searchForm').serializeArray();
		  ...
		  object.jisa = ljsIsNull(object.jisa) ? '' : object.jisa;
		  				...
		  				// 주소
		  				var ask = (object.privateUseRadio02 == undefined || object.privateUseRadio02 == null) ? '0' : object.privateUseRadio02;
		  				console.log("privateUseRadio02:" + ask);
		...
		var allData={"excel":""};
		$.ajax({
				url: "/land/gover/menu03_1ExcelDownload",  // PNU 기준으로 데이터를 가져오는 API
